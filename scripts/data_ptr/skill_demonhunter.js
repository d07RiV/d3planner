  ...
  multishot: {
    ...
    info: function(rune, stats) {
      ...
      if (!$.isEmptyObject(total)) {
        ...
        total["Damage"] = {};
        res["Total Damage"] = total;
        res["DPS"] = {sum: true, "Total Damage": {speed: 1, ias: (stats.leg_yangsrecurve ? 40 : 0), fpa: 56.666664, round: "up"}};
      } else {
        res["DPS"] = {sum: true, "Damage": {speed: 1, ias: (stats.leg_yangsrecurve ? 40 : 0), fpa: 56.666664, round: "up"}};
      }
/*
