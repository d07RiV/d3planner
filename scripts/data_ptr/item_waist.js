DiabloCalc.addItems([
...

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_hunterswrath", name: "Generator Damage Bonus", format: "Your Hatred generators attack 30%% faster and deal %d%% increased damage.", min: 30, max: 40},
    },
    preset: ["mainstat", "vit"],
  },

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_sacredharness", name: "Falling Sword Casts Judgment", format: "Judgment is cast at your landing location when casting Falling Sword.", args: 0},
    },
    preset: ["mainstat"],
  },

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_fazulasimprobablechain", name: "Archon Stacks Extra Bonuses", format: "Archon stacks also increase your Attack Speed, Armor and Resistances by 1%%.", args: 0},
    },
    preset: ["mainstat"],
  },
