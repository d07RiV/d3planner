...
//    check: true,
  ...
  soulshard: {
    ...
    effects: [
      ...
      {
        format: "After gaining a level, your resource costs are removed and cooldowns on skills are reduced by 75%% for 15 seconds.",
      },
    ],
    info: function(level, stats) {
      return {"Damage": {elem: "fir", coeff: 10 + 1.4 * level}};
    },
    buffs: function(level, stats) {
