DiabloCalc.itemSets = {
  ...
  manajuma: {
    ...
    bonuses: {
      "2": [
        {format: "Your Hex - Angry Chicken explosion damage is increased by 100%% and slain enemies trigger an additional explosion."},
  ...
  shenlong: {
    ...
    bonuses: {
      "2": [
        {format: "The damage of your Spirit Generators is increased by 1%% for each point of Spirit you have."},
        {format: "When reaching maximum Spirit, all damage is increased by 300%%, but you no longer passively regenerate Spirit and 65 Spirit is drained every second until you run out of Spirit."},
      ],
    },
  },
  ...
  vyr: {
    ...
    bonuses: {
      ...
      "4": [
        {format: "You automatically start with 50 Archon stacks when entering Archon form."},
      ],
      "6": [
  ...
  helltooth: {
    ...
    bonuses: {
      "2": [
        {format: "Enemies hit by Wall of Death are afflicted by Necrosis, becoming Slowed and taking 2500%% weapon damage every second for 10 seconds."},
      ],
      "4": [
        {format: "After applying Necrosis to an enemy, you take 50%% reduced damage for 10 seconds."},
      ],
      "6": [
        {format: "Enemies afflicted by Necrosis take an 800%% increased damage from your primary skills, Acid Cloud, Firebats, Zombie Charger, Grasp of the Dead, Piranhas, and Wall of Death."},
      ],
    },
  },
  ...
  light: {
    ...
    bonuses: {
      ...
      "6": [
        {format: "Increase the damage of Blessed Hammer by 750%% and Falling Sword by 250%%."},
      ],
    },
  },
  ...
  arachyr: {
    ...
    bonuses: {
      "2": [
        {format: "Summon a permanent Spider Queen who leaves behind webs that deal 1500%% weapon damage over 5 seconds and Slows enemies. The Spider Queen is commanded to move to where you cast your Corpse Spiders."},
      ],
      "4": [
      ...
      "6": [
        {format: "The damage of your creature skills is increased by 500%%. Creature skills are Corpse Spiders, Plague of Toads, Firebats, Hex, and Piranhas."},
      ],
    },
  },
