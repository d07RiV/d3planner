DiabloCalc.itemSets = {
  ...
  nightmares: {
    ...
    bonuses: {
      "2": [
        {format: "While this is your only Item Set bonus every Ancient item you have equipped increases your damage dealt by 500%% and reduces your damage taken by 4%%."},
      ],
    },
  },
  ...
  talrasha: {
    ...
    bonuses: {
      ...
      "6": [
        {format: "Attacks increase your damage by 3000%% for 8 seconds. Arcane, Cold, Fire, and Lightning attacks each add one stack. At 4 stacks, each different elemental attack extends the duration by 2 seconds, up to a maximum of 8 seconds."},
      ],
    },
  },
  ...
  raekor: {
    ...
    bonuses: {
      ...
      "6": [
        {format: "Every use of Furious Charge increases the damage of your next Fury-spending attack by 7000%%. This effect stacks. Every use of a Fury-spending attack consumes up to 5 stacks."},
      ],
    },
  },
  ...
  inna: {
    ...
    bonuses: {
      ...
      "6": [
        {format: "Gain the five runed Mystic Allies at all times and your damage is increased by 1500%% for each Mystic Ally you have out."},
      ],
    },
  },
