DiabloCalc.itemSets = {
  ...
  savages: {
    ...
    bonuses: {
      "2": [
        {format: "Double the effectiveness of shouts. Feared enemies take double damage."},
      ],
      "4": [
        {format: "Each Frenzy stack reduces damage taken by 5%%."},
      ],
      "6": [
  ...
  mundunugu: {
    ...
    bonuses: {
      ...
      "4": [
        {format: "Gain 50%% damage reduction for 30 seconds when you enter the spirit realm."},
      ],
      "6": [
        {format: "Spirit Barrage deals increased damage equal to 50 times your Mana Regeneration/Second."},
      ],
    },
  },
  ...
  typhon: {
    ...
    bonuses: {
      ...
      "4": [
        {format: "Damage taken is reduced by 8%% for each Hydra head alive. Each time you take damage, a head dies."},
      ],
      "6": [
        {format: "Hydras deal 1000%% increased damage for each Hydra head alive."},
      ],
    },
  },
};
