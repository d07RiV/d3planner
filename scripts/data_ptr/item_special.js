...
//      }
  ...
  leg_bracersofthefirstmen: {
    ...
    active: true,
    buffs: function(value, stats) {
      if (stats.skills.hammeroftheancients) {
        return {ias: value[0]};
      }
    },
  },
  ...
  set_light_6pc: {
    buffs: {dmgmul: {list: [
      ...
      {skills: ["fallingsword"], percent: 250},
    ]}},
  },
  set_shenlong_2pc: {
    active: true,
  ...
  set_helltooth_6pc: {
    ...
    buffs: function(value, stats) {
      if (stats.skills.wallofzombies) {
        return {dmgmul: {pet: false, skills: ["poisondart", "corpsespiders", "plagueoftoads", "firebomb",
          "acidcloud", "firebats", "zombiecharger", "graspofthedead", "piranhas", "wallofdeath"], percent: 800}};
      }
    },
  },
  set_arachyr_2pc: {
    info: {"DPS": {elem: "max", pet: true, coeff: 3, total: true}},
  },
  set_arachyr_6pc: {
    buffs: {dmgmul: {skills: ["corpsespiders", "plagueoftoads", "firebats", "hex", "piranhas"], percent: 500}},
  },
};
