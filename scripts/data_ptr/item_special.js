...
//  },
  ...
  set_typhon_6pc: {
    buffs: function(value, stats) {
      return {dmgmul: {skills: ["hydra"], percent: 1000 * DiabloCalc.skills.wizard.hydra.params[0].val}};
    },
  },
  ...
  set_mundunugu_6pc: {
    last: true,
    buffs: function(value, stats) {
      return {dmgmul: 50 * (stats.manaregen + (stats.manaregen_percent || 0) * stats.maxmana * 0.01) * (1 + 0.01 * (stats.resourcegen || 0))};
    },
  },
  ...
  set_savages_4pc: {
    buffs: function(value, stats) {
      return {dmgred: DiabloCalc.skills.barbarian.frenzy.params[0].val};
    },
  },
  set_savages_6pc: {
    buffs: function(value, stats) {
