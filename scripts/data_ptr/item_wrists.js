...
/*  {
...

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_bracersofdestruction", name: "Seismic Slam Damage Increase", format: "Seismic Slam deals %d%% increased damage to the first two enemies it hits.", min: 300, max: 400},
    },
    preset: ["mainstat", "chc"],
  },

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_bracersofthefirstmen", name: "HotA Attack Speed", format: "When Hammer of the Ancients hits an enemy, gain %d%% increased Attack Speed for 3 seconds.", min: 75, max: 100},
    },
    preset: ["mainstat", "chc"],
  },

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_jeramsbracers", name: "Double Wall of Death", format: "Wall of Death can be cast up to twice again within 2 seconds before the cooldown begins.", args: 0},
    },
    preset: ["mainstat", "chc"],
  },

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_coilsofthefirstspider", name: "Firebats Life on Hit", format: "While channeling Firebats, gain %d Life per Hit.", min: 60000, max: 80000},
    },
