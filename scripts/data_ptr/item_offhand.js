DiabloCalc.addItems([
...

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_henrisperquisition", name: "Damage Reduction", format: "The first time an enemy deals damage to you, reduce that damage by %d%% and Charm the enemy for 3 seconds.", min: 45, max: 60},
      dura: "one",
    },
    preset: ["chc", "mainstat"],
    secondary: 3,
