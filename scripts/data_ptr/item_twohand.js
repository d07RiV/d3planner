...
/*  {
...

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_faithfulmemory", name: "Blessed Hammer Bonus Damage", format: "Each enemy hit by Falling Sword increases the damage of Blessed Hammer by %d%% for 10 seconds.", min: 50, max: 60},
    },
    preset: ["wpnhol", "mainstat"],
  },
