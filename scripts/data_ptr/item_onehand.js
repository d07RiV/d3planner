DiabloCalc.addItems([
...

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_karleispoint_p6", name: "Impale Damage Increase", format: "The damage of Impale is increased by %d%% and it returns 15 Hatred if it hits an enemy already Impaled.", min: 60, max: 80},
    },
    preset: ["mainstat", "wpncol"],
  },
