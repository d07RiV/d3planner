DiabloCalc.addItems([
...

  {
    ...
    required: {
      custom: {id: "leg_thebarber", name: "Spirit Barrage Explosion Damage", format: "Instead of dealing direct damage, your Spirit Barrage now accumulates on the target. When you stop channeling it explodes dealing %d%% of the accumulated damage to all enemies within 15 yards.", min: 225, max: 250},
    },
    preset: ["mainstat", "damage", "chd"],
  },

  {
    ...
    required: {
      custom: {id: "leg_rabidstrike", name: "Epiphany Teleport Echoes Spenders", format: "Spirit Spenders that teleport you while Epiphany is active are also mimicked on a distant target for free.", args: 0},
    },
