...
//    suffix: _L("Legacy"),
...

  {
    ...
    quality: "legendary",
    required: {
      custom: {id: "leg_dishonoredlegacy", name: "Cleave Extra Damage", format: "Cleave deals up to %d%% increased damage based on percentage on missing Fury.", min: 300, max: 400},
    },
    preset: ["mainstat"],
  },
