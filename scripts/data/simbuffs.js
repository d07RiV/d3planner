...
//    languish: {name: "Soul Harvest - Languish", category: "Skills", classes: ["witchdoctor"], skill: ["soulharvest", "c"]},
    ...
    jadeharvester_6pc: {name: "Raiment of the Jade Harvester (6)", category: "Item Sets", set: ["jadeharvester", 6]},
    ...
    wastes_4pc: {name: "Wrath of the Wastes (4)", category: "Item Sets", set: ["wastes", 6]},
    ...
    triumvirate: {name: "Triumvirate", category: "Items", stat: ["leg_triumvirate", "leg_triumvirate_p2", "leg_triumvirate_p6"]},
    ...
    spiritguards: {name: "Spirit Guards", category: "Items", stat: ["leg_spiritguards", "leg_spiritguards_p6"]},
    bindingofthelost: {name: "Binding of the Lost", category: "Items", stat: ["leg_bindingofthelost", "leg_bindingofthelost_p6"]},
    wrapsofclarity: {name: "Wraps of Clarity", category: "Items", stat: ["leg_wrapsofclarity", "leg_wrapsofclarity_p6"]},
    theswami: {name: "The Swami", category: "Items", stat: ["leg_theswami", "leg_theswami_p3"]},
    denial: {name: "Denial", category: "Items", stat: ["leg_denial", "leg_denial_p6"]},
    ...
    cesarsmemento: {name: "Cesar's Memento", category: "Items", stat: ["leg_cesarsmemento", "leg_cesarsmemento_p6"]},
    ...
    bandofmight: {name: "Band of Might", category: "Items", stat: ["leg_bandofmight", "leg_bandofmight_p6"]},
    ...
    lordgreenstonesfan: {name: "Lord Greenstone's Fan", category: "Items", stat: ["leg_lordgreenstonesfan", "leg_lordgreenstonesfan_p2", "leg_lordgreenstonesfan_p6"]},
    orbofinfinitedepth: {name: "Orb of Infinite Depth", category: "Items", stat: ["leg_orbofinfinitedepth", "leg_orbofinfinitedepth_p6"]},
    ...
    haloofkarini: {name: "Halo of Karini", category: "Items", stat: ["leg_haloofkarini", "leg_haloofkarini_p6"]},
    ...
    girdleofgiants: {name: "Girdle of Giants", category: "Items", stat: ["leg_girdleofgiants", "leg_girdleofgiants_p6"]},
    ...
    faithfulmemory: {name: "Faithful Memory", category: "Items", stat: ["leg_faithfulmemory", "leg_faithfulmemory_p6"]},
